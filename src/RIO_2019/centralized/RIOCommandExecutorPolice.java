...
public class RIOCommandExecutorPolice extends CommandExecutor<CommandPolice> {
    ...
    public RIOCommandExecutorPolice(AgentInfo ai, WorldInfo wi, ScenarioInfo si, ModuleManager moduleManager, DevelopData developData) {
        super(ai, wi, si, moduleManager, developData);
        this.commandType = ACTION_UNKNOWN;

        switch  (scenarioInfo.getMode()) {
            case PRECOMPUTATION_PHASE:
                this.pathPlanning = moduleManager.getModule("CommandExecutorPolice.PathPlanning", "RIO_2019.module.algorithm.AstarPathPlanningPolice");
                this.actionExtClear = moduleManager.getExtAction("CommandExecutorPolice.ActionExtClear", "RIO_2019.extaction.RIOActionExtClear");
                this.actionExtMove = moduleManager.getExtAction("CommandExecutorPolice.ActionExtMove", "RIO_2019.extaction.RIOActionExtMove");
                break;
            case PRECOMPUTED:
                this.pathPlanning = moduleManager.getModule("CommandExecutorPolice.PathPlanning", "RIO_2019.module.algorithm.AstarPathPlanningPolice");
                this.actionExtClear = moduleManager.getExtAction("CommandExecutorPolice.ActionExtClear", "RIO_2019.extaction.RIOActionExtClear");
