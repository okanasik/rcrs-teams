...
public class RIOCommandActionFireFighting extends ExtAction
{
	...
	public RIOCommandActionFireFighting(AgentInfo agentInfo, WorldInfo worldInfo, ScenarioInfo scenarioInfo, ModuleManager moduleManager, DevelopData developData)
	{
