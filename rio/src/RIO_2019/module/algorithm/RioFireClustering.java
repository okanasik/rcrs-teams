...
public class RioFireClustering extends DynamicClustering {
	private int groupingDistance;
	private List<List<StandardEntity>> clusterList = new LinkedList<>();
	private List<EntityID> changedList;

	public RioFireClustering(AgentInfo ai, WorldInfo wi, ScenarioInfo si, ModuleManager moduleManager,
			DevelopData developData) {
		super(ai, wi, si, moduleManager, developData);
		this.groupingDistance = developData
				.getInteger("adf.sample.module.algorithm.SampleFireClustering.groupingDistance", 30);
