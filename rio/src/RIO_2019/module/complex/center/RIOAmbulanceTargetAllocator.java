...
public class RIOAmbulanceTargetAllocator extends AmbulanceTargetAllocator {
    public RIOAmbulanceTargetAllocator(AgentInfo ai, WorldInfo wi, ScenarioInfo si, ModuleManager moduleManager, DevelopData developData) {
