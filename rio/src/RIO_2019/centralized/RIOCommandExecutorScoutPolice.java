...
public class RIOCommandExecutorScoutPolice extends CommandExecutor<CommandScout> {
    ...
    public RIOCommandExecutorScoutPolice(AgentInfo ai, WorldInfo wi, ScenarioInfo si, ModuleManager moduleManager, DevelopData developData) {
        ...
        switch  (scenarioInfo.getMode()) {
            case PRECOMPUTATION_PHASE:
                this.pathPlanning = moduleManager.getModule("CommandExecutorScoutPolice.PathPlanning", "RIO_2019.module.algorithm.AstarPathPlanningPolice");
                this.actionExtClear = moduleManager.getExtAction("CommandExecutorScoutPolice.ActionExtClear", "RIO_2019.extaction.RIOActionExtClear");
                break;
            case PRECOMPUTED:
                this.pathPlanning = moduleManager.getModule("CommandExecutorScoutPolice.PathPlanning", "RIO_2019.module.algorithm.AstarPathPlanningPolice");
                this.actionExtClear = moduleManager.getExtAction("CommandExecutorScoutPolice.ActionExtClear", "RIO_2019.extaction.RIOActionExtClear");
