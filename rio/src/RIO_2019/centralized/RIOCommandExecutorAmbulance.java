...
public class RIOCommandExecutorAmbulance extends CommandExecutor<CommandAmbulance> {
    ...
    public RIOCommandExecutorAmbulance(AgentInfo ai, WorldInfo wi, ScenarioInfo si, ModuleManager moduleManager, DevelopData developData) {
        super(ai, wi, si, moduleManager, developData);
        this.type = ACTION_UNKNOWN;
        switch  (scenarioInfo.getMode()) {
            case PRECOMPUTATION_PHASE:
                this.pathPlanning = moduleManager.getModule("CommandExecutorAmbulance.PathPlanning", "RIO_2019.module.algorithm.AstarPathPlanning");
                this.actionTransport = moduleManager.getExtAction("CommandExecutorAmbulance.ActionTransport", "RIO_2019.extaction.RioneTransport");
                this.actionExtMove = moduleManager.getExtAction("CommandExecutorAmbulance.ActionExtMove", "RIO_2019.extaction.RIOActionExtMove");
                break;
            case PRECOMPUTED:
                this.pathPlanning = moduleManager.getModule("CommandExecutorAmbulance.PathPlanning", "RIO_2019.module.algorithm.AstarPathPlanning");
                this.actionTransport = moduleManager.getExtAction("CommandExecutorAmbulance.ActionTransport", "RIO_2019.extaction.RioneTransport");
